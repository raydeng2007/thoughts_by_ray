...
similar to when I first started learning programming, the pieces of the puzzle are like dominos, it just 
takes a bit of time to get the knowledge snowball to get rolling. 


<figure>
<img src={Surfer} alt="Surfer" style="width:100%"/>
<figcaption align = "center">Lone surfer in San Diego</figcaption>
</figure>
